...
knitr::include_graphics("./figs/jetstream/Project1.png")
```
...
knitr::include_graphics("./figs/jetstream/Project2.png")
```
Select the 'Marine Genomics' directory and then select 'week4':
&nbsp;

```{r three, echo=FALSE, out.width = '100%'}
knitr::include_graphics("./figs/jetstream/Project3.png")
```
...
knitr::include_graphics("./figs/jetstream/Robjects.png")
```
