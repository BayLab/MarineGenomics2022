...
##         -s (seed random init)                  140459784059100
...
## Main algorithm:
## 
## Least-square error: 472471.812287
...
##         - diploid
## 
## Cross-Entropy (all data):	 0.334761
## Cross-Entropy (masked data):	 0.335858
## The project is saved into :
##  filtered_3699snps_californicus_685inds.recode.snmfProject 
## 
## To load the project, use:
...
## 
## Least-square error: 466836.844204
...
##         - diploid
## 
## Cross-Entropy (all data):	 0.328856
## Cross-Entropy (masked data):	 0.332929
## The project is saved into :
##  filtered_3699snps_californicus_685inds.recode.snmfProject 
## 
## To load the project, use:
...
## 
## Least-square error: 463329.416452
...
##         - diploid
## 
## Cross-Entropy (all data):	 0.324939
## Cross-Entropy (masked data):	 0.331227
## The project is saved into :
##  filtered_3699snps_californicus_685inds.recode.snmfProject 
## 
## To load the project, use:
...
## 
## Least-square error: 462342.458430
...
##         - diploid
## 
## Cross-Entropy (all data):	 0.323919
## Cross-Entropy (masked data):	 0.332533
## The project is saved into :
##  filtered_3699snps_californicus_685inds.recode.snmfProject 
## 
## To load the project, use:
...
## 
## Least-square error: 460594.204378
...
##         - diploid
## 
## Cross-Entropy (all data):	 0.323006
## Cross-Entropy (masked data):	 0.33293
## The project is saved into :
##  filtered_3699snps_californicus_685inds.recode.snmfProject 
## 
## To load the project, use:
...
## 
## Least-square error: 459137.923942
...
##         - diploid
## 
## Cross-Entropy (all data):	 0.322394
## Cross-Entropy (masked data):	 0.334037
## The project is saved into :
##  filtered_3699snps_californicus_685inds.recode.snmfProject 
## 
## To load the project, use:
...
## 
## Least-square error: 458157.385480
...
##         - diploid
## 
## Cross-Entropy (all data):	 0.321424
## Cross-Entropy (masked data):	 0.334576
## The project is saved into :
##  filtered_3699snps_californicus_685inds.recode.snmfProject 
## 
## To load the project, use:
...
## 
## Least-square error: 457117.928237
...
##         - diploid
## 
## Cross-Entropy (all data):	 0.321004
## Cross-Entropy (masked data):	 0.335879
## The project is saved into :
##  filtered_3699snps_californicus_685inds.recode.snmfProject 
## 
## To load the project, use:
...
## 
## Least-square error: 455362.865575
...
##         - diploid
## 
## Cross-Entropy (all data):	 0.319914
## Cross-Entropy (masked data):	 0.334729
## The project is saved into :
##  filtered_3699snps_californicus_685inds.recode.snmfProject 
## 
## To load the project, use:
...
## 
## Least-square error: 454453.627317
...
##         - diploid
## 
## Cross-Entropy (all data):	 0.319423
## Cross-Entropy (masked data):	 0.335382
## The project is saved into :
##  filtered_3699snps_californicus_685inds.recode.snmfProject 
## 
## To load the project, use:
...
##         -b (burnin)                     5000
##         -s (seed random init)           140459203572934
...
## 
## 	ED:2533818.205	 DIC: 2533819.171 
## 
...
## 		End of the Gibbs Sampler algorithm.
## 
## 	ED:2533817.935	 DIC: 2533818.932 
## 
## 	The statistics for the run are registered in:
...
##         -i (number of iterations)       10000
##         -b (burnin)                     5000
##         -s (seed random init)           1340917888198
##         -p (number of processes (CPU))  1
##         -x (genotype file)              filtered_3699snps_californicus_685inds.recode.lfmm
##         -v (variable file)              sites_environ_matrix.env
##         -D (number of covariables)      5
...
##         -i (number of iterations)       10000
##         -b (burnin)                     5000
##         -s (seed random init)           4644636183776670918
##         -p (number of processes (CPU))  1
##         -x (genotype file)              filtered_3699snps_californicus_685inds.recode.lfmm
##         -v (variable file)              sites_environ_matrix.env
##         -D (number of covariables)      5
...
## 		End of the Gibbs Sampler algorithm.
## 
## 	ED:2533818.129	 DIC: 2533819.167 
## 
## 	The statistics for the run are registered in:
