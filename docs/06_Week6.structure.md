...
## Chain 1: 
## Chain 1: Gradient evaluation took 0.0084 seconds
## Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 84 seconds.
...
## Chain 1: 
## Chain 1:  Elapsed Time: 0.111332 seconds (Warm-up)
## Chain 1:                0.100135 seconds (Sampling)
## Chain 1:                0.211467 seconds (Total)
## Chain 1:
```
