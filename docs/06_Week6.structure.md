...
## Chain 1: 
## Chain 1: Gradient evaluation took 0.013655 seconds
## Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 136.55 seconds.
...
## Chain 1: 
## Chain 1:  Elapsed Time: 0.099841 seconds (Warm-up)
## Chain 1:                0.089957 seconds (Sampling)
## Chain 1:                0.189798 seconds (Total)
## Chain 1:
```
