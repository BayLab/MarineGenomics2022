...
## Chain 1: 
## Chain 1: Gradient evaluation took 0.014046 seconds
## Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 140.46 seconds.
...
## Chain 1: 
## Chain 1:  Elapsed Time: 0.105131 seconds (Warm-up)
## Chain 1:                1.24805 seconds (Sampling)
## Chain 1:                1.35318 seconds (Total)
## Chain 1:
```
