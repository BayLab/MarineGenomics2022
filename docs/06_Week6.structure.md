...
## Chain 1: 
## Chain 1: Gradient evaluation took 0.008633 seconds
## Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 86.33 seconds.
...
## Chain 1: 
## Chain 1:  Elapsed Time: 0.100577 seconds (Warm-up)
## Chain 1:                0.271831 seconds (Sampling)
## Chain 1:                0.372408 seconds (Total)
## Chain 1:
```
