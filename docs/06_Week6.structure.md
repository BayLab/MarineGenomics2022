...
## Chain 1: 
## Chain 1: Gradient evaluation took 0.008771 seconds
## Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 87.71 seconds.
...
## Chain 1: 
## Chain 1:  Elapsed Time: 0.107577 seconds (Warm-up)
## Chain 1:                0.087932 seconds (Sampling)
## Chain 1:                0.195509 seconds (Total)
## Chain 1:
```
