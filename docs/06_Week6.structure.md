...
## Chain 1: 
## Chain 1: Gradient evaluation took 0.014 seconds
## Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 140 seconds.
...
## Chain 1:                4.618 seconds (Sampling)
## Chain 1:                4.878 seconds (Total)
## Chain 1:
```
