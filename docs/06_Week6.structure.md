...
## Chain 1: 
## Chain 1: Gradient evaluation took 0.009686 seconds
## Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 96.86 seconds.
...
## Chain 1: 
## Chain 1:  Elapsed Time: 0.134064 seconds (Warm-up)
## Chain 1:                0.086363 seconds (Sampling)
## Chain 1:                0.220427 seconds (Total)
## Chain 1:
```
