...
## Chain 1: 
## Chain 1: Gradient evaluation took 0.013012 seconds
## Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 130.12 seconds.
...
## Chain 1: 
## Chain 1:  Elapsed Time: 0.175207 seconds (Warm-up)
## Chain 1:                5.33869 seconds (Sampling)
## Chain 1:                5.5139 seconds (Total)
## Chain 1:
```
