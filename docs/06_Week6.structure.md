...
## Chain 1: 
## Chain 1: Gradient evaluation took 0.012425 seconds
## Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 124.25 seconds.
...
## Chain 1: 
## Chain 1:  Elapsed Time: 0.081033 seconds (Warm-up)
## Chain 1:                0.080757 seconds (Sampling)
## Chain 1:                0.16179 seconds (Total)
## Chain 1:
```
