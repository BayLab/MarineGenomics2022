...
## Chain 1: 
## Chain 1: Gradient evaluation took 0.009136 seconds
## Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 91.36 seconds.
...
## Chain 1: 
## Chain 1:  Elapsed Time: 0.109853 seconds (Warm-up)
## Chain 1:                0.083882 seconds (Sampling)
## Chain 1:                0.193735 seconds (Total)
## Chain 1:
```
