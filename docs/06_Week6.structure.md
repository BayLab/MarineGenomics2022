...
## Chain 1: 
## Chain 1: Gradient evaluation took 0.009181 seconds
## Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 91.81 seconds.
...
## Chain 1: 
## Chain 1:  Elapsed Time: 0.149832 seconds (Warm-up)
## Chain 1:                7.61159 seconds (Sampling)
## Chain 1:                7.76142 seconds (Total)
## Chain 1:
```
